...
A visually appealing pizza menu website built using **HTML and CSS**.  
This project focuses on clean UI design, modern styling, and smooth animations, created as a practice project for learning frontend web development.
...
- Learn basic animations and effects  
- Understand website deployment using Vercel  
- Build a beginner-friendly frontend project for GitHub  
